  ...
  const stopSound = async () => {
    if (sound) {
      try {
        ...
        // pode falhar se o som já estiver parado
      }
    ...
    if (!isRecording) {
      ...
      try {
        ...
        if (recording) {
          ...
          if (uri) {
            // Para e descarrega som atual antes de trocar áudio
            await stopSound();
  ...
  const handlePlay = async () => {
    if (audioUri) {
      try {
        ...
        // Configura o modo de áudio antes de tocar
        await Audio.setAudioModeAsync({
        ...
        // Descarrega som anterior, se houver
        if (sound) {
          await sound.unloadAsync();
          setSound(null);
        }
